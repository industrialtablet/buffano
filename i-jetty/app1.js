        ...
        $.fn.templet.defaults = {
            ...
            'settings': {
                ...
                '1366*768': {
                    ...
                    'height':768,
                    'widget_margins': [0, 0],
                    'widget_base_dimensions': [227.66, 128],
                    'min_cols': 6
                },
                '1280*720': {
                    'width':1280,
                    'height':720,
                    'widget_margins': [0, 0],
                    'widget_base_dimensions': [213.2, 120],
                    'min_cols': 6
                }
            },
            widgetW : 0,
...
/*                opts._debug(opts.curPlayTaskIds);*/
            ...
            buildWidgetContent : function(widget, type, plays) {
                 ...
                 var width = parseInt(widget['size_x']*opts.widgetW,10), height = parseInt(widget['size_y']*opts.widgetH, 10);
            ...
            makeGrid : function(widgetList, screen) {
                ...
                $.each(widgetList, function(index, widget){
                    html += '<li id="widget_'+widget.id+'" data-row="'+widget.row+'" data-col="'+widget.col+'" data-sizex="'+widget.size_x+'" data-sizey="'+widget.size_y+'" >';
                    html += '</li>';
                });
                html += '</ul></div>';
