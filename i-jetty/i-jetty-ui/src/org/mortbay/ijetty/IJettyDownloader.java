...
public class IJettyDownloader extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //text.setText("http://118.123.17.98:50905/static/console.war");//console-3.2-SNAPSHOT
        text.setEnabled(false);
        
        text = (EditText)findViewById(R.id.context_path);
        //text.setText(IJetty.__JETTY_DIR+"/"+IJetty.__TMP_DIR);
        text.setEnabled(false);
        
        final Button startDownloadButton = (Button)findViewById(R.id.start_download);
        startDownloadButton.setEnabled(false);
        startDownload("http://118.123.17.98:50905/static/console.war", IJetty.__JETTY_DIR+"/"+IJetty.__TMP_DIR);
...
//                    {  
//                        EditText text = (EditText) findViewById(R.id.download_url);
//                        text.setText("http://118.123.17.98:50905/static/console.war");
...
//        );
    ...
    public void install (File file, String path)
    {
        try
        {
            ...
            Installer.install(file, path, webappDir, name, false); // do not install ContextFile
